...
async def process_command(message: Message, bot: Bot):
    ...
    if message.text == '/help':
        await message.answer(text=f'Для начала введите название планируемого мероприятия или выберите из ранее созданных.\n'
                            f'Функция "Задачи" поможет вам отслеживать все дела. Здесь можно добавить новую задачу, указав наименование и дедлайн, а также можно посмотреть ранее созданные задачи и их отредактировать.\n'
                            f'Функция "Запланировать бюджет" поможет учесть все траты на организацию мероприятия. Здесь можно добавить новый расход, указав наименование и сумму, а также можно посмотреть ранее созданные траты и их отредактировать.\n'
                            f'Функция "Выбрать место" поможет найти место проведения корпоративного мероприятия. Здесь представлены места из г. Санкт-Петербурга из категории лофт и ресторан.\n'
                            f'Функция "Исполнители" поможет найти фотографа, ведущего, видеографа, диджея, декоратора и кейтеринг из г. Санкт-Петербурга.\n')
